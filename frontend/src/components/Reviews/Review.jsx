        ...
        <div className='m-2.5 bg-gray-50 p-2.5 rounded-sm'>
            <article>
                ...
                <div class="flex items-center mb-1 space-x-1 rtl:space-x-reverse">
                    <svg class="w-4 h-4 text-purple-600" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 22 20">
                ...
                <div>
                    ...
                    <div class="flex items-center mt-3">
                        <a href="#" class="px-2 py-1.5 text-xs font-medium text-white focus:outline-none bg-purple-600 rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-purple-600 focus:z-10 focus:ring-4 focus:ring-gray-100">Helpful</a>
