...
import AllSkillCard from '../components/Skills/AllSkillCard';
...
const CollectionList = () => {
  ...
  useEffect(() => {
    const fetchSkills = async () => {
      ...
      try {
        const response = await axios.get(`http://localhost:5000/skill/getcollection/${userId}`);
  ...
  return (
    <div className="min-h-screen bg-gradient-to-r from-purple-100 to-blue-200 py-10">
      <div className="max-w-7xl mx-auto px-6">
        <h2 className="text-5xl font-bold text-start text-purple-950 mb-2">Your Collection</h2>
        <h2 className="text-xl font-semibold text-start text-gray-400 mb-10">Start learning your favoruite skills now.</h2>
